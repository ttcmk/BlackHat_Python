...
bing_api_key = "a67495b836f84dba848b9afb7655c667"
...
class BurpExtender(IBurpExtender, IContextMenuFactory):
    def registerExtenderCallbacks(self, callbacks):
        ...
        # 建立扩展工具
        callbacks.setExtensionName("BurpSuite Bing")
    ...
    def bing_query(self, bing_query_string):
        ...
        json_body = self._callbacks.makeHttpRequest("api.datamarket.azure.com", 443, True,
